...
if (!get_setting('admin_email') && !get_setting('gchat_webhook')) {
    $config_warnings[] = 'No notifications configured. <a href="settings.php">Configure email or Google Chat</a> to receive completion alerts.';
}
...
<nav class="navbar navbar-dark bg-dark mb-4">
  <div class="container">
    ...
    <div class="d-flex gap-2">
      <a href="upload.php" class="btn btn-primary btn-sm"><i class="bi bi-plus-lg"></i> New Gallery</a>
      <a href="rosters.php" class="btn btn-outline-light btn-sm"><i class="bi bi-people"></i> Rosters</a>
...
<div class="container">
  ...
  <?php if (empty($galleries)): ?>
    <div class="text-center py-5 text-muted">
      ...
      <p class="mt-2">No galleries yet. <a href="upload.php">Create one.</a></p>
    </div>
  <?php else: ?>
    <div class="row g-3">
      ...
      <div class="col-md-6 col-lg-4">
        <div class="card gallery-card h-100">
          ...
          <div class="card-footer bg-transparent d-flex gap-2">
            <a href="view.php?id=<?= $g['id'] ?>" class="btn btn-sm btn-outline-primary flex-grow-1">
              <i class="bi bi-eye"></i> View Results
            </a>
            <a href="export.php?gallery_id=<?= $g['id'] ?>" class="btn btn-sm btn-outline-secondary" title="Download CSV">
